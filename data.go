...
var currencySymbols = map[string][]symbolInfo{
	...
	"JPY": {
		{"¥", []string{"en", "en-AU"}},
		{"JP¥", []string{"af", "am", "ar", "as", "az", "bn", "cs", "cy", "da", "el", "el-polyton", "en-001", "en-CA", "eu", "gd", "gl", "gu", "hi", "hy", "id", "is", "kk", "km", "ko", "kok", "ky", "lo", "mn", "mr", "ms", "my", "ne", "nl", "pa", "pcm", "ps", "pt", "si", "so", "sq", "sw", "te", "tk", "ur", "uz", "yue-Hans", "zh", "zu"}},
		{"￥", []string{"ja"}},
	},
	"KES": {
		{"KES", []string{"en"}},
