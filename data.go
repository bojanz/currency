...
var currencyCodes = []string{
	...
	"BTN", "BWP", "BYN", "BZD", "CDF", "CHE", "CHW", "CLF", "CLP", "CNY",
	"COP", "COU", "CRC", "CUP", "CVE", "CZK", "DJF", "DKK", "DOP", "DZD",
	...
	"MXN", "MXV", "MYR", "MZN", "NAD", "NGN", "NIO", "NPR", "OMR", "PAB",
	"PEN", "PGK", "PHP", "PKR", "PLN", "PYG", "QAR", "RON", "RSD", "RUB",
	"RWF", "SAR", "SBD", "SCR", "SDG", "SGD", "SHP", "SLE", "SOS", "SRD",
	"SSP", "STN", "SVC", "SYP", "SZL", "THB", "TJS", "TMT", "TND", "TOP",
	"TRY", "TTD", "TWD", "TZS", "UAH", "UGX", "USN", "UYI", "UYU", "UYW",
...
var currencies = map[string]currencyInfo{
	...
	"BGN": {"975", 2}, "BHD": {"048", 3}, "BIF": {"108", 0},
	"BMD": {"060", 2}, "BND": {"096", 2}, "BOB": {"068", 2},
	"BOV": {"984", 2}, "BRL": {"986", 2}, "BSD": {"044", 2},
	"BTN": {"064", 2}, "BWP": {"072", 2}, "BYN": {"933", 2},
	"BZD": {"084", 2}, "CAD": {"124", 2}, "CDF": {"976", 2},
	"CHE": {"947", 2}, "CHF": {"756", 2}, "CHW": {"948", 2},
	"CLF": {"990", 4}, "CLP": {"152", 0}, "CNY": {"156", 2},
	"COP": {"170", 2}, "COU": {"970", 2}, "CRC": {"188", 2},
	...
	"XAD": {"396", 2}, "XAF": {"950", 0}, "XCD": {"951", 2},
	"XCG": {"532", 2}, "XOF": {"952", 0}, "XPF": {"953", 0},
	"YER": {"886", 2}, "ZAR": {"710", 2}, "ZMW": {"967", 2},
	"ZWG": {"924", 2},
}
...
var currencySymbols = map[string][]symbolInfo{
	...
	"JPY": {
		{"¥", []string{"en", "en-AU"}},
		{"JP¥", []string{"af", "ak", "am", "ar", "as", "az", "ba", "bn", "chr", "cs", "cv", "cy", "da", "el", "el-polyton", "en-001", "en-CA", "en-EE", "en-GE", "en-LT", "en-LV", "en-UA", "eu", "gd", "gl", "gu", "hi", "hy", "id", "is", "jv", "kk", "km", "kn", "ko", "kok", "ky", "lo", "mn", "mr", "ms", "my", "ne", "nl", "pa", "pcm", "ps", "pt", "qu", "rm", "sd", "shn", "si", "so", "sq", "sw", "te", "tk", "ur", "uz", "yo", "zh", "zu"}},
		{"￥", []string{"ja"}},
	},
	"KES": {
		{"KES", []string{"en"}},
	...
	"RUB": {
		{"RUB", []string{"en", "kk-Arab"}},
		{"₽", []string{"be", "cv", "kk", "ru", "yo"}},
	},
	"RWF": {
		{"RWF", []string{"en"}},
	...
	"USD": {
		...
		{"$US", []string{"fr", "qu"}},
		{"$\u00a0US", []string{"fr-CA"}},
		{"US$", []string{"ak", "am", "ar", "as", "az", "bn", "cs", "cy", "da", "en-001", "en-CA", "en-EE", "en-GE", "en-LT", "en-LV", "en-UA", "es", "es-AR", "es-CL", "es-CO", "es-CU", "es-DO", "es-UY", "eu", "gu", "id", "jv", "ka", "kk-Arab", "ko", "kok", "lo", "mk", "my", "ne", "nl", "pa", "pcm", "pt", "sd", "shn", "si", "so", "sq", "sr", "sr-Latn", "sv", "sw", "ta-SG", "th", "ti", "tk", "uz", "vi", "yue", "yue-Hans", "zh", "zh-Hant"}},
		{"щ.д.", []string{"bg"}},
	},
	"UYU": {
		{"UYU", []string{"en", "fr-CA"}},
