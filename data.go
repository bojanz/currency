...
var currencySymbols = map[string][]symbolInfo{
	...
	"JPY": {
		{"¥", []string{"en", "en-AU"}},
		{"JP¥", []string{"af", "ak", "am", "ar", "as", "az", "ba", "bn", "chr", "cs", "cv", "cy", "da", "el", "el-polyton", "en-001", "en-CA", "eu", "gd", "gl", "gu", "hi", "hy", "id", "is", "jv", "kk", "kk-Arab", "km", "kn", "ko", "kok", "ky", "lo", "mn", "mr", "ms", "my", "ne", "nl", "pa", "pcm", "ps", "pt", "qu", "rm", "sd", "shn", "si", "so", "sq", "sw", "te", "tk", "ur", "uz", "yo", "zh", "zu"}},
		{"￥", []string{"ja"}},
	},
	"KES": {
		{"KES", []string{"en"}},
	...
	"USD": {
		...
		{"$US", []string{"fr", "qu"}},
		{"$\u00a0US", []string{"fr-CA"}},
		{"US$", []string{"ak", "am", "ar", "as", "az", "bn", "cs", "cy", "da", "en-001", "en-CA", "es", "es-AR", "es-CL", "es-CO", "es-CU", "es-DO", "es-UY", "eu", "gu", "id", "jv", "ka", "kk-Arab", "ko", "kok", "lo", "mk", "my", "ne", "nl", "pa", "pcm", "pt", "sd", "shn", "si", "so", "sq", "sr", "sr-Latn", "sv", "sw", "ta-SG", "th", "ti", "tk", "uz", "vi", "yue", "yue-Hans", "zh", "zh-Hant"}},
		{"щ.д.", []string{"bg"}},
	},
	"UYU": {
		{"UYU", []string{"en", "fr-CA"}},
